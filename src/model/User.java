...
public class User {
    private String name, lastname, login, password, phone;
    ...
    public User(String name, String lastname, String login, String password, String phone, LocalDate birth_date, LocalDateTime registration_date_time) {
        this.name = name;
        this.lastname = lastname;
        this.login = login;
        this.password = password;
